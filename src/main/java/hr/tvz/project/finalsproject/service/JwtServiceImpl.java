...
import hr.tvz.project.finalsproject.user.ApplicationUser;
import hr.tvz.project.finalsproject.user.UserAuthentication;
...
public class JwtServiceImpl implements JwtService {
    ...
    private boolean isJwtInvalid(String jtwToken){
        try{
            Jwts.parser().setSigningKey(secretKey).parseClaimsJws(jtwToken);
            return false;
